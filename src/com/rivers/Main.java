...
public class Main {
	public static void main(String[] args) {
		...
		WaterPath wp1 = new WaterPath(startPoint1, 4, 0, 100, 500, 500);
		WaterPath wp2 = new WaterPath(startPoint2, 4, 0, 100, 500, 500);
		WaterPath wp3 = new WaterPath(startPoint3, 4, 0, 1000, 500, 500);
